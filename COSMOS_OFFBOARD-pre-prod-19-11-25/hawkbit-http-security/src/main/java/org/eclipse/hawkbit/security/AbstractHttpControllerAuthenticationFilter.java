...
public abstract class AbstractHttpControllerAuthenticationFilter extends AbstractPreAuthenticatedProcessingFilter {
     ...
     * request. e.g."/device/v1/tenants/{tenant}/controllers/{controllerId}
     */
    private static final String CONTROLLER_REQUEST_ANT_PATTERN = "/device/v*/tenants/{" + TENANT_PLACE_HOLDER + "}/controllers" + "/{"
