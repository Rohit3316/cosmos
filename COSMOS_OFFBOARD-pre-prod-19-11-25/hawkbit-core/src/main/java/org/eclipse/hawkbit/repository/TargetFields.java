...
public enum TargetFields implements FieldNameProvider {
     ...
     */
    ID(TargetFields.CONTROLLER_ID_FIELD_NAME),
     ...
     * The controllerId field.
     */
    CONTROLLERID(TargetFields.CONTROLLER_ID_FIELD_NAME),
    /**
     * The controllerId field.
     */
    VIN(TargetFields.CONTROLLER_ID_FIELD_NAME),
    /**
     ...
     */
    ASSIGNEDDS("assignedDistributionSet", "name", TargetFields.VERSION_FIELD_NAME),

    /**
     * distribution sets which is installed on the target.
     */
    INSTALLEDDS("installedDistributionSet", "name", TargetFields.VERSION_FIELD_NAME),
     ...
     * The target type.
     */
    SOFTWARE("softwares", "componentId", TargetFields.VERSION_FIELD_NAME);
    ...
    private static final String CONTROLLER_ID_FIELD_NAME = "controllerId";
