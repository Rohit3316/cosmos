...
class RSQLSoftwareModuleFieldTest extends AbstractJpaIntegrationTest {
    ...
    public void setupBeforeTest() {
        ah = softwareModuleManagement.create(entityFactory.softwareModule().create().type(appType).name("agent-hub")
                .version("1.0.1").description("agent-hub").format(format).swInstallerType(swInstallerType));
        softwareModuleManagement.create(entityFactory.softwareModule().create().type(runtimeType).name("oracle-jre")
                .version("1.7.2").description("aa").format(format).swInstallerType(swInstallerType));
        ...
        softwareModuleManagement
                .create(entityFactory.softwareModule().create().type(osType).name("*§$%&/&%ÄÜ*Ö@").version("1.0.0")
                        .description("wildcard testing").format(format).swInstallerType(swInstallerType));
        softwareModuleManagement
        ...
        final JpaSoftwareModule ah2 = (JpaSoftwareModule) softwareModuleManagement.create(entityFactory.softwareModule()
                .create().type(appType).name("agent-hub2").version("1.0.1").description("agent-hub2").format(format).swInstallerType(swInstallerType));
    ...
    void testFilterByParameterName() {
        ...
        assertRSQLQuery(SoftwareModuleFields.NAME.name() + NON_EXIST_QUERY, 0);
    ...
    void testFilterByParameterDescription() {
        ...
        assertRSQLQuery(SoftwareModuleFields.DESCRIPTION.name() + NON_EXIST_QUERY, 0);
    ...
    void testFilterByType() {
        ...
        assertRSQLQuery(SoftwareModuleFields.TYPE.name() + NON_EXIST_QUERY, 0);
    ...
    void testFilterByMetadata() {
        ...
        assertRSQLQuery(SoftwareModuleFields.METADATA.name() + ".metaKey" + NON_EXIST_QUERY, 0);
