...
public class RemoteTenantAwareEventTest extends AbstractRemoteEventTest {
    ...
    private Action createAction(final String controllerId) {
        ...
        generateAction.setUserAcceptanceRequired(MgmtRolloutUserAcceptanceRequired.NO);
        generateAction.setTarget(testdataFactory.createTarget(controllerId,controllerId,controllerId,testdataFactory.createVehicle(controllerId).getId(),controllerId));
        generateAction.setStatus(DeviceActionStatus.RUNNING);
    ...
    public void testTargetAssignDistributionSetEvent() {
        ...
        final JpaAction generateAction = new JpaAction();
        generateAction.setUserAcceptanceRequired(MgmtRolloutUserAcceptanceRequired.NO);
        generateAction.setTarget(testdataFactory.createTarget("Test", "Test", "Test", testdataFactory.createVehicle("X250").getId(),"vin"));
