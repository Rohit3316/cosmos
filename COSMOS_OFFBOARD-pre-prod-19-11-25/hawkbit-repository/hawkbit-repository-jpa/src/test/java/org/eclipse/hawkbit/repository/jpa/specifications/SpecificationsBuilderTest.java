...
public class SpecificationsBuilderTest {
    ...
    public void combineWithAndSingleImmutableList() {
        final Specification<Object> spec = (root, query, cb) -> cb.equal(root.get(FIELD + '1'), "testValue");
        ...
        when(root.get(FIELD + '1')).thenReturn(field1);
    ...
    public void combineWithAndList() {
        final Specification<Object> spec1 = (root, query, cb) -> cb.equal(root.get(FIELD + '1'), "testValue1");
        final Specification<Object> spec2 = (root, query, cb) -> cb.equal(root.get(FIELD + '2'), "testValue2");
        ...
        when(root.get(FIELD + '1')).thenReturn(field1);
        when(root.get(FIELD + '2')).thenReturn(field2);
