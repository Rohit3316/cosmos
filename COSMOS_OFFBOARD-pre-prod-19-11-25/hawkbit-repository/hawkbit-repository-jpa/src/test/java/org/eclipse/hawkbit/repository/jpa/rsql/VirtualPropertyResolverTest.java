...
public class VirtualPropertyResolverTest {
    ...
    private static final String LHS_LT_QUERY = "lhs=lt=";
    ...
    void resolveNowTimestampPlaceholder(final String placeholder) {
        ...
        final String testString = LHS_LT_QUERY + placeholder;
    ...
    public void handleEscapedPlaceholder() {
        ...
        final String testString = LHS_LT_QUERY + escaptedPlaceholder;
