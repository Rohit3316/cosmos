...
public abstract class AbstractAutoAssignExecutor implements AutoAssignExecutor {
    ...
    protected List<DeploymentRequest> mapToDeploymentRequests(final List<String> controllerIds,
        ...
        final MgmtRolloutUserAcceptanceRequired userAcceptanceRequired = filterQuery.getAutoAssignUserAcceptanceRequired() == null
                ? MgmtRolloutUserAcceptanceRequired.YES
                : filterQuery.getAutoAssignUserAcceptanceRequired();
        ...
        return controllerIds.stream()
                .map(controllerId -> DeploymentManagement
                        ...
                        .setUserAcceptanceRequired(userAcceptanceRequired).setWeight(filterQuery.getAutoAssignWeight().orElse(null))
