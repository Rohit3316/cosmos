...
public class JpaTargetFilterQuery extends AbstractJpaTenantAwareBaseEntity
    ...
    @Column(name = "auto_assign_user_acceptance_required", nullable = true)
    @ObjectTypeConverter(name = "autoAssignUserAcceptanceRequired", objectType = MgmtRolloutUserAcceptanceRequired.class, dataType = Integer.class, conversionValues = {
            @ConversionValue(objectValue = "NO", dataValue = "0"),
            @ConversionValue(objectValue = "YES", dataValue = "1")})
    @Convert("autoAssignUserAcceptanceRequired")
    private MgmtRolloutUserAcceptanceRequired autoAssignUserAcceptanceRequired = MgmtRolloutUserAcceptanceRequired.YES;
     ...
     *            of the {@link TargetFilterQuery}.
     * @param autoAssignUserAcceptanceRequired
     *            of the {@link TargetFilterQuery}.
    ...
    public JpaTargetFilterQuery(final String name, final String query, final DistributionSet autoAssignDistributionSet,
                                final MgmtRolloutUserAcceptanceRequired autoAssignUserAcceptanceRequired, final Integer autoAssignWeight, final boolean confirmationRequired) {
        this.name = name;
        this.query = query;
        this.autoAssignDistributionSet = (JpaDistributionSet) autoAssignDistributionSet;
        this.autoAssignUserAcceptanceRequired = autoAssignUserAcceptanceRequired;
