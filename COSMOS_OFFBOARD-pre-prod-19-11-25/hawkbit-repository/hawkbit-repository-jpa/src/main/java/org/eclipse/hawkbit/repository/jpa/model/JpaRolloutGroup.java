...
public class JpaRolloutGroup extends AbstractJpaNamedEntity implements RolloutGroup, EventAwareEntity {
    ...
    @ObjectTypeConverter(name = "rolloutgroupstatus", objectType = RolloutGroupStatus.class, dataType = Integer.class, conversionValues = {
            ...
            @ConversionValue(objectValue = "QUEUING", dataValue = "5"),
            @ConversionValue(objectValue = "QUEUED", dataValue = "6"),
            @ConversionValue(objectValue = "STARTING", dataValue = "7"),
            @ConversionValue(objectValue = "RUNNING", dataValue = "8"),
            @ConversionValue(objectValue = "PAUSING", dataValue = "9"),
            @ConversionValue(objectValue = "PAUSED", dataValue = "10"),
            @ConversionValue(objectValue = "RESUMING", dataValue = "11"),
            @ConversionValue(objectValue = "CANCELING", dataValue = "12"),
            @ConversionValue(objectValue = "CANCELED", dataValue = "13"),
            @ConversionValue(objectValue = "FINISHING", dataValue = "14"),
            @ConversionValue(objectValue = "FINISHED", dataValue = "15"),
            @ConversionValue(objectValue = "ERROR", dataValue = "16"),
            @ConversionValue(objectValue = "DELETING", dataValue = "17"),
            @ConversionValue(objectValue = "DELETED", dataValue = "18"),
            @ConversionValue(objectValue = "RETRYING", dataValue = "19"),
            @ConversionValue(objectValue = "RETRY", dataValue = "20")
    })
    ...
    public TotalTargetCountStatus getTotalTargetCountStatus() {
        if (totalTargetCountStatus == null) {
            totalTargetCountStatus = new TotalTargetCountStatus(Long.valueOf(totalTargets), rollout.getUserAcceptanceRequired());
        }
