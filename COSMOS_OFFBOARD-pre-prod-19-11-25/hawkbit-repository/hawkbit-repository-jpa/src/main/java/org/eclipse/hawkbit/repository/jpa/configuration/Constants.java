...
public final class Constants {
    ...
    /**
     * Filetype of sns message.
     */
    public static final String ARTIFACT = "ARTIFACT";

    public static final String ARTIFACTS = "artifact";

    public static final String UNLINK = "Unlink Software Module from Distribution Set";

    public static final String DELETE_SOFTWARE_MODULE = "Delete Software Module";
    /**
