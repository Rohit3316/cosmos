...
public abstract class AbstractTargetFilterQueryUpdateCreate<T> extends AbstractBaseEntityBuilder {
    ...
    protected MgmtRolloutUserAcceptanceRequired userAcceptanceRequired;
    ...
    /**
     * Set the user acceptance required for the auto assignment.
     *
     * @param userAcceptanceRequired the user acceptance required for the auto assignment
     * @return this builder
     */
    public T autoAssignUserAcceptanceRequired(final MgmtRolloutUserAcceptanceRequired userAcceptanceRequired) {
    ...
    public Optional<MgmtRolloutUserAcceptanceRequired> getAutoAssignUserAcceptanceRequired() {
