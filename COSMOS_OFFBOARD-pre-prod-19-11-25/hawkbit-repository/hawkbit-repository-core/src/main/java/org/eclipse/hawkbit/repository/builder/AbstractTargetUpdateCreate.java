...
public class AbstractTargetUpdateCreate<T> extends AbstractNamedEntityBuilder<T> {
    ...
    public T serialNumber(final String serialNumber) {
        this.serialNumber = StringUtils.trimWhitespace(serialNumber);
        return (T) this;
    }
    ...
    public T vehicleModelId(final Long vehicleModelId) {
        this.vehicleModelId = vehicleModelId;
        return (T) this;
    }

    public T vin(final String vin) {
        this.vin = StringUtils.trimWhitespace(vin);
        return (T) this;
    }
    ...
    public String gerSerialNumber() { return serialNumber; }
