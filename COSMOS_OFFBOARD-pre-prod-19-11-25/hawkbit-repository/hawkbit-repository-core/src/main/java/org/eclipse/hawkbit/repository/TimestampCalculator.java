...
public final class TimestampCalculator {
    ...
    public static long calculateOverdueTimestamp() {
        return Instant.now().getEpochSecond() - getDurationForKey(TenantConfigurationKey.POLLING_TIME_INTERVAL).getSeconds()
                - getDurationForKey(TenantConfigurationKey.POLLING_OVERDUE_TIME_INTERVAL).getSeconds();
    }
