...
public final class RepositoryConstants {
    ...
    /**
     * Maximum number of feedbacks that can be retrieved.
     */
    ...
    /**
     * Default key of target attributes insert on config data.
     */
    public static final String INVENTORY_HASH_KEY = "inventory.signature";

    public static final String INVENTORY_HASH_KEY_OLD = "inventoryHash.value";

    /**g
     * Default value for artifact version.
     */
    public static final String DEFAULT_ARTIFACT_VERSION = "1";
