...
public class DeploymentRequest {
    ...
    @Valid
    private final TargetWithUserAcceptanceRequired targetWithUserAcceptanceRequired;
     ...
     */
    public DeploymentRequest(final String controllerId, final Long distributionSetId, final MgmtRolloutUserAcceptanceRequired userAcceptanceRequired,
        ...
        this.targetWithUserAcceptanceRequired = new TargetWithUserAcceptanceRequired(controllerId, userAcceptanceRequired, forceTime, weight,
    ...
    public String getControllerId() {
        return targetWithUserAcceptanceRequired.getControllerId();
    }

    public TargetWithUserAcceptanceRequired getTargetWithUserAcceptanceRequired() {
        return targetWithUserAcceptanceRequired;
    }

    @Override
    public String toString() {
        return String.format(
                "DeploymentRequest [controllerId=%s, distributionSetId=%d, userAcceptanceRequired=%s, forceTime=%d, weight=%d, maintenanceSchedule=%s, maintenanceWindowDuration=%s, maintenanceWindowTimeZone=%s, confirmationRequired=%s]",
                targetWithUserAcceptanceRequired.getControllerId(), getDistributionSetId(), targetWithUserAcceptanceRequired.getUserAcceptanceRequired(),
                targetWithUserAcceptanceRequired.getForceTime(), targetWithUserAcceptanceRequired.getWeight(),
                targetWithUserAcceptanceRequired.getMaintenanceSchedule(), targetWithUserAcceptanceRequired.getMaintenanceWindowDuration(),
                targetWithUserAcceptanceRequired.getMaintenanceWindowTimeZone(), targetWithUserAcceptanceRequired.isConfirmationRequired());
    }

    @Override
    public int hashCode() {
        return Objects.hash(distributionSetId, targetWithUserAcceptanceRequired);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.equals(distributionSetId, other.distributionSetId)
                && Objects.equals(targetWithUserAcceptanceRequired, other.targetWithUserAcceptanceRequired);
    }
}
