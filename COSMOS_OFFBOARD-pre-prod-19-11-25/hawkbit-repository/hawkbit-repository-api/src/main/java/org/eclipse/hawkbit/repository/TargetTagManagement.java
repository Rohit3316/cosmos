...
public interface TargetTagManagement {
     ...
     * @throws ConstraintViolationException
     *             if fields are not filled as specified. Check
     *             {@link TargetTag} for field constraints.
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_CREATE_TARGET)
    TargetTag create(@NotNull @Valid TargetTag targetTag);

    /**
     * Create a target tag
     * @param tagName tag name to create a tag
     * @param description description to create a tag
     * @param colour colour to create a tag
     * @return newly created targetTag
     */
    TargetTag createTargetTag(@NotNull @Valid String tagName, String description, String colour);

    /**
     * associate target tag with targets
     * @param tag target tag
     * @param controllerIds list of targets to associated
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_CREATE_TARGET)
    void associateTagWithTargets(@NotNull TargetTag tag, @NotNull @Valid List<String> controllerIds);
