...
public interface ConfirmationManagement {
    ...
    /**
     * Find active actions in the {@link DeviceActionStatus#WAIT_FOR_CONFIRMATION} state
     ...
     * {@link DeviceActionStatus#WAIT_FOR_CONFIRMATION} status.
     * 
     * @param controllerId
     ...
     * {@link DeviceActionStatus#WAIT_FOR_CONFIRMATION} to {@link DeviceActionStatus#RUNNING}
     * state.
     * 
     * @param actionId
     ...
     * {@link DeviceActionStatus#WAIT_FOR_CONFIRMATION} state.
     *
     * @param actionId
