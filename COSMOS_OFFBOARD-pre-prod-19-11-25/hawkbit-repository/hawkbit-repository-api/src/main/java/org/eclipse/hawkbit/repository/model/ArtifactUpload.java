...
public class ArtifactUpload {
    ...
    public ArtifactUpload(final InputStream inputStream, final long moduleId, final String filename,
            final boolean overrideExisting, final long filesize, FileType fileType, final Long sourceVersion, final Long targetVersion) {
        this(inputStream, moduleId, filename, null, null, null, overrideExisting,
                null, filesize, fileType, sourceVersion, targetVersion);
    }
    ...
    public ArtifactUpload(final InputStream inputStream, final long moduleId, final String filename,
            ...
            final boolean overrideExisting, final String contentType, final long filesize,
                          final FileType fileType, final Long sourceVersion, final Long targetVersion) {
