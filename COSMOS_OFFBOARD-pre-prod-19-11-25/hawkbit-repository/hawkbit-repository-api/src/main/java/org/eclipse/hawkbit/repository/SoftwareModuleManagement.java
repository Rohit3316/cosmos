...
public interface SoftwareModuleManagement
    ...
    /**
     * Retrieves {@link SoftwareModule} by their name and tenant.
     *
     * @param name
     *            of the {@link SoftwareModule}
     *
     ...
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_READ_REPOSITORY)
    Optional<SoftwareModule> getByScomoName(@NotEmpty String name);

    /**
     * Retrieves the ID of a {@link SoftwareModule} by its name.
     * @param name - the name of the software module
     * @return - the ID of the software module if it exists, otherwise an empty Optional
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_READ_REPOSITORY)
    Optional<Long> getIdByScomoName(@NotEmpty String name);
    ...
    void assignEcuModel(Long softwareModuleId, List<Long> ecuModelIds);

    /**
     * Assigns the given ECU models to the specified software module.
     * @param softwareModule - the software module to which the ECU models will be assigned
     * @param ecuModelIds - the list of ECU model IDs to be assigned
     */
    @PreAuthorize(SpPermission.SpringEvalExpressions.HAS_AUTH_CREATE_TARGET)
    void assignEcuModel(SoftwareModule softwareModule, List<Long> ecuModelIds);

    /**
     * Retrieves the {@link SoftwareModule}s by their {@link SoftwareModuleType}
     * .
     *
     * @param softwareModule software module
     * @param ecuModelIds      removes the association of ECU models for given ecuModelIds from given Software Module
     * @throws EntityNotFoundException if software module type with given ID does not exist
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_DELETE_TARGET)
    void removeAssociatedEcuModels(SoftwareModule softwareModule, List<Long> ecuModelIds);

    /**
     * Retrieves the {@link SoftwareModule}s by their {@link SoftwareModuleType}
     * .
     *
     * @param softwareModuleId software module
     * @param ecuModelIds      removes the association of ECU models for given ecuModelIds from given Software Module
     * @throws EntityNotFoundException if software module type with given ID does not exist
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_DELETE_TARGET)
    void removeAssociatedEcuModels(Long softwareModuleId, List<Long> ecuModelIds);

    /**
     * Retrieves the {@link SoftwareModule}s by their {@link SoftwareModuleType}
     * .
     *
     * @param moduleId software module
     * @return set of @{@link DistributionSet} IDs for the given Software Module
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_READ_REPOSITORY)
    List<DistributionSet> getDistributionSetByModuleId(final Long moduleId);

    /**
     * Searches for a {@link SoftwareModule} with the given ID.
     *
     * @param id the ID of the software module to search for
     * @return an {@link Optional} containing the found {@link SoftwareModule}, or {@link Optional#empty()} if not found
     */

    @PreAuthorize(SpPermission.SpringEvalExpressions.HAS_AUTH_READ_TARGET)
    Optional<SoftwareModule> getSoftwareModuleById(@NotNull @Valid long id);

    /**
     * Checks if a software module with the given name already exists for the given tenant.
     * @param name   the name of the software module to check for uniqueness
