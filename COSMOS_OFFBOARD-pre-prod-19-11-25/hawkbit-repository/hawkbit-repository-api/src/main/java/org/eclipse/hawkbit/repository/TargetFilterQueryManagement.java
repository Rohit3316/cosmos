...
public interface TargetFilterQueryManagement {
     ...
     * Creates a new {@link TargetFilterQuery}.
     *
     * @param targetFilterQuery to create
     * @return the new {@link TargetFilterQuery}
     *
     * @throws ConstraintViolationException
     *             if fields are not filled as specified. Check
     *             {@link TargetFilterQuery} for field constraints.
     *
     * @throws AssignmentQuotaExceededException
     *             if the maximum number of targets that is addressed by the
     *             given query is exceeded (auto-assignments only)
     ...
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_CREATE_TARGET)
    TargetFilterQuery create(@NotNull @Valid TargetFilterQuery targetFilterQuery);
     ...
     *
     * @throws InvalidAutoAssignUserAcceptanceRequiredException
     *             if the provided auto-assign {@link MgmtRolloutUserAcceptanceRequired} is not valid
     *
