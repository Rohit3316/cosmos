...
public class InvalidMD5HashException extends AbstractServerRtException {
    ...
    */
     ...
     * {@link ServerError#ARTIFACT_UPLOAD_FAILED_MD5_MATCH} error.
     */
    public InvalidMD5HashException() {
        super(ServerError.ARTIFACT_UPLOAD_FAILED_MD5_MATCH);
    }
    ...
    public InvalidMD5HashException(final String message, final Throwable cause) {
        super(message, ServerError.ARTIFACT_UPLOAD_FAILED_MD5_MATCH, cause);
    }
    ...
    public InvalidMD5HashException(final String message) {
        super(message, ServerError.ARTIFACT_UPLOAD_FAILED_MD5_MATCH);
    }
