...
public class TargetAttributesRequestedEvent extends RemoteIdEvent {
     ...
     */
    public TargetAttributesRequestedEvent(final String tenant, final Long entityId, final String controllerId,final Class<? extends TenantAwareBaseEntity> entityClass,
