...
public interface TargetFilterQueryCreate {
    ...
    /**
     * Set {@link MgmtRolloutUserAcceptanceRequired} for auto assignment
     * 
     * @param userAcceptanceRequired
     *            for {@link TargetFilterQuery#getAutoAssignUserAcceptanceRequired()}
     * @return updated builder instance
     */
    TargetFilterQueryCreate autoAssignUserAcceptanceRequired(MgmtRolloutUserAcceptanceRequired userAcceptanceRequired);
