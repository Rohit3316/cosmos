...
public interface RolloutGroupManagement {
    ...
    /**
     * Assigns the targets based on the filter provided in the rollout to the provided rollout group
     *
     * @param rollout with targets
     * @param rolloutGroups List of groups for the targets assignment
     * @return list of associated
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_ROLLOUT_MANAGEMENT_CREATE)
    List<AssociatedTargetsToRolloutGroup> assignTargetsToRolloutGroups(final Rollout rollout, final List<RolloutGroup> rolloutGroups);

    /**
     * Creates rollout groups and link it to the rollout for the provided list of group details/list
     *
     * @param groupList group details list
     * @param rollout to associate
     * @param controllerIds list of controllerIds to be added in group
     * @return list of {@link RolloutGroup}
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_ROLLOUT_MANAGEMENT_CREATE)
    List<RolloutGroup> createRolloutGroups(final List<RolloutGroup> groupList, final Rollout rollout, List<String> controllerIds);

    /**
     * Creates a rollout group with default conditions and link it with the rollout provided.
     *
     * @param rollout to associate
     * @return {@link RolloutGroup}
     */
    @PreAuthorize(SpringEvalExpressions.HAS_AUTH_ROLLOUT_MANAGEMENT_CREATE)
    RolloutGroup createDefaultRolloutGroup(Rollout rollout);
