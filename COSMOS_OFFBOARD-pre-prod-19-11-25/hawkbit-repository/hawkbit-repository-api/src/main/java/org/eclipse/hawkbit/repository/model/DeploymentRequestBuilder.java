...
public class DeploymentRequestBuilder {
    ...
    /**
     * Set an other {@link MgmtRolloutUserAcceptanceRequired} than {@link MgmtRolloutUserAcceptanceRequired#NO}
     * 
     * @param userAcceptanceRequired
     *            type to used
     * @return builder
     */
    public DeploymentRequestBuilder setUserAcceptanceRequired(final MgmtRolloutUserAcceptanceRequired userAcceptanceRequired) {
    ...
    public DeploymentRequest build() {
        return new DeploymentRequest(controllerId, distributionSetId, userAcceptanceRequired, forceTime, weight,
