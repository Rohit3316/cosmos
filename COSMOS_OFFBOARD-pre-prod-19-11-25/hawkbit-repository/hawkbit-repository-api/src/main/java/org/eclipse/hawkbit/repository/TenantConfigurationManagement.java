...
public interface TenantConfigurationManagement {
     ...
     * @throws ConversionFailedException             if the property cannot be converted to the given data type
     */
    @PreAuthorize(value = SpringEvalExpressions.HAS_AUTH_SYSTEM_ADMIN
     ...
     *
     * @param configurationKeyName the key of the configuration
     *                             will retrieve default values from configuration properties for a given key
     * @return the configuration value which was just written into the database.
     * @throws TenantConfigurationValidatorException if the {@code propertyType} and the value in general does not
     *                                               match the expected type and format defined by the Key
     * @throws ConversionFailedException             if the property cannot be converted to the given data type
    ...
    @PreAuthorize(value = SpringEvalExpressions.HAS_AUTH_SYSTEM_ADMIN
            + SpringEvalExpressions.HAS_AUTH_OR + SpringEvalExpressions.HAS_AUTH_TENANT_CONFIG_CREATE
            + SpringEvalExpressions.HAS_AUTH_OR + SpringEvalExpressions.HAS_AUTH_TENANT_CONFIG_UPDATE)
    <T extends Serializable> TenantConfigurationValue<T> addOrUpdateConfiguration(String configurationKeyName);
     ...
     * @param tenantConfiguration the configuration
     * @return <null> if no default value is set and no database value available
     * or returns the tenant configuration value
     */
    @PreAuthorize(value = SpringEvalExpressions.HAS_AUTH_SYSTEM_ADMIN
            + SpringEvalExpressions.HAS_AUTH_OR + SpringEvalExpressions.HAS_AUTH_TENANT_CONFIG_READ)
     ...
     */
    @PreAuthorize(value = SpringEvalExpressions.HAS_AUTH_SYSTEM_ADMIN
            + SpringEvalExpressions.HAS_AUTH_OR + SpringEvalExpressions.HAS_AUTH_TENANT_CONFIG_DELETE)
     ...
     *
     * @param configurationKeyName the key of the configuration
     * @param tenant               fetch configuration of specific tenant
    ...
    @PreAuthorize(value = SpringEvalExpressions.HAS_AUTH_SYSTEM_ADMIN
            + SpringEvalExpressions.HAS_AUTH_OR + SpringEvalExpressions.HAS_AUTH_TENANT_CONFIG_READ)
    <T extends Serializable> TenantConfigurationValue<T> getConfigurationValue(String configurationKeyName, String tenant);
    ...
    @PreAuthorize(value = SpringEvalExpressions.HAS_AUTH_SYSTEM_ADMIN
            + SpringEvalExpressions.HAS_AUTH_OR + SpringEvalExpressions.HAS_AUTH_TENANT_CONFIG_READ)
    <T extends Serializable> TenantConfigurationValue<T> getConfigurationValueByTenant(String configurationKeyName,
                                                                                       Class<T> propertyType, String tenant);
    ...
    /**
     * Checks a specific configuration key for the given tenant.
     *
    ...
    @PreAuthorize(value = SpringEvalExpressions.HAS_AUTH_SYSTEM_ADMIN
            + SpringEvalExpressions.HAS_AUTH_OR + SpringEvalExpressions.HAS_AUTH_TENANT_CONFIG_READ)
    Boolean existsByKey(String configurationKey);
