...
public class HawkbitSecurityProperties {
    ...
    public static class Dos {
        ...
        /**
         * Maximum artifacts version per software module
         */
        private int maxArtifactsVersionPerSoftwareModule = 50;
         ...
         */
        private long maxArtifactSize = 17_179_869_184L;

        /**
         * Maximum size of all artifacts in bytes. Defaults to 20 GB.
         */
        private long maxArtifactStorage = 107_374_182_400L;
        ...
        public int getMaxArtifactsVersionPerSoftwareModule() {
            return maxArtifactsVersionPerSoftwareModule;
        }

        public void setMaxArtifactsVersionPerSoftwareModule(final int maxArtifactsVersionPerSoftwareModule) {
            this.maxArtifactsVersionPerSoftwareModule = maxArtifactsVersionPerSoftwareModule;
        }
