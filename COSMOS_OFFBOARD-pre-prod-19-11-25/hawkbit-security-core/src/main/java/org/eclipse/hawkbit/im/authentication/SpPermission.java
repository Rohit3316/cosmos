...
public final class SpPermission {
    ...
    /**
     * Permission to create tenant metadata.
     */
    public static final String CREATE_TENANT = "CREATE_TENANT";

    /**
     * Permission to read all tenant metadata in COSMOS.
     */
    public static final String READ_ALL_TENANT = "READ_ALL_TENANT";

    /**
     * Permission to read tenant metadata and tenant statistics.
     */
    public static final String READ_TENANT = "READ_TENANT";

    /**
     * Permission to update tenant metadata.
     */
    public static final String UPDATE_TENANT = "UPDATE_TENANT";

    /**
     * Permission to delete tenant metadata.
     */
    public static final String DELETE_TENANT = "DELETE_TENANT";

    /**
     * Permission to create tenant configurations.
     */
    public static final String CREATE_TENANT_CONFIG = "CREATE_TENANT_CONFIG";

    /**
     * Permission to read tenant configurations.
     */
    public static final String READ_TENANT_CONFIG = "READ_TENANT_CONFIG";

    /**
     * Permission to update tenant configurations.
     */
    public static final String UPDATE_TENANT_CONFIG = "UPDATE_TENANT_CONFIG";

    /**
     * Permission to delete tenant configurations.
     */
    public static final String DELETE_TENANT_CONFIG = "DELETE_TENANT_CONFIG";
    ...
    public static final class SpringEvalExpressions {
        ...
        /**
         * The role which contains the spring security context in case the
         * M2M APIs are executing code which is necessary to be privileged.
         */
        ...
        /**
         * The all tenants permission for M2M API role {@link SpPermission.SpringEvalExpressions#API_ROLE}.
         */
        public static final String ALL_TENANTS = "ALL-TENANTS";
        ...
        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #CREATE_TENANT} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_CREATE = HAS_AUTH_PREFIX + CREATE_TENANT + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #READ_ALL_TENANT} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_ALL_TENANT_READ = HAS_AUTH_PREFIX + READ_ALL_TENANT + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #READ_TENANT} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_READ = HAS_AUTH_PREFIX + READ_TENANT + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #UPDATE_TENANT} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_UPDATE = HAS_AUTH_PREFIX + UPDATE_TENANT + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #DELETE_TENANT} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_DELETE = HAS_AUTH_PREFIX + DELETE_TENANT + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #CREATE_TENANT_CONFIG} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_CONFIG_CREATE = HAS_AUTH_PREFIX + CREATE_TENANT_CONFIG + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #READ_TENANT_CONFIG} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_CONFIG_READ = HAS_AUTH_PREFIX + READ_TENANT_CONFIG + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #UPDATE_TENANT_CONFIG} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_CONFIG_UPDATE = HAS_AUTH_PREFIX + UPDATE_TENANT_CONFIG + HAS_AUTH_SUFFIX;

        /**
         * Spring Security evaluation authority expression to check if the Spring
         * context contains {@link #DELETE_TENANT_CONFIG} with appropriate prefix and suffix.
         */
        public static final String HAS_AUTH_TENANT_CONFIG_DELETE = HAS_AUTH_PREFIX + DELETE_TENANT_CONFIG + HAS_AUTH_SUFFIX;
        ...
        public static final String HAS_AUTH_ROLE_READ = HAS_AUTH_PREFIX + READ_ROLE + HAS_AUTH_SUFFIX;

        public static final String HAS_AUTH_ROLE_DELETE = HAS_AUTH_PREFIX + DELETE_ROLE + HAS_AUTH_SUFFIX;

        public static final String HAS_AUTH_ROLE_UPDATE = HAS_AUTH_PREFIX + UPDATE_ROLE + HAS_AUTH_SUFFIX;

        public static final String HAS_AUTH_ROLE_CREATE_UPDATE = HAS_AUTH_PREFIX + CREATE_ROLE + HAS_AUTH_SUFFIX +
                HAS_AUTH_OR + HAS_AUTH_ROLE_UPDATE;
