...
public class DdiSecurityProperties {
    ...
    private boolean createTargetOnRun = false;
    ...
    /**
     * @return the createTargetOnRun
     */
    public boolean isCreateTargetOnRun() {
        return createTargetOnRun;
    }

    /**
     * @param createTargetOnRun the createTargetOnRun to set
     */
    public void setCreateTargetOnRun(boolean createTargetOnRun) {
        this.createTargetOnRun = createTargetOnRun;
    }
    ...
    public static class Rp {
        ...
        /**
         * @param cnHeader the cnHeader to set
         */
        ...
        /**
         * @param sslIssuerHashHeader the sslIssuerHashHeader to set
         */
