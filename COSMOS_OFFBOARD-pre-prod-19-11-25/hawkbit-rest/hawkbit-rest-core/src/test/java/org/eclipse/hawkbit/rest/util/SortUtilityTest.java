...
import org.eclipse.hawkbit.exception.SortParameterSyntaxErrorException;
import org.eclipse.hawkbit.exception.SortParameterUnsupportedDirectionException;
import org.eclipse.hawkbit.exception.SortParameterUnsupportedFieldException;
import org.eclipse.hawkbit.pagination.SortUtility;
...
public class SortUtilityTest {
    ...
    private static final String PARSING_PARAMETER = "Count of parsing parameter";
    ...
    public void parseSortParam1() {
        ...
        assertThat(parse).as(PARSING_PARAMETER).hasSize(1);
    }
    ...
    public void parseSortParam2() {
        ...
        assertThat(parse).as(PARSING_PARAMETER).hasSize(2);
    }
    ...
    public void parsingIsNotCaseSensitive() {
        final List<Order> parse = SortUtility.parse(TargetFields.class, CASE_INSENSITIVE_DIRECTION_PARAM);
        assertThat(parse).as(PARSING_PARAMETER).hasSize(1);
        final List<Order> parsedField = SortUtility.parse(TargetFields.class, CASE_INSENSITIVE_DIRECTION_PARAM_1);
        assertThat(parsedField).as(PARSING_PARAMETER).hasSize(1);
    }
