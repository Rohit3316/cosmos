...
public class ExceptionInfoTest {
    ...
    public void setterAndGetterOnExceptionInfo() {
        ...
        underTest.setDebug(knownErrorCode);
        underTest.setName(knownExceptionClass);
        underTest.setMessage(knownMessage);
        underTest.setParameters(knownParameters);

        assertThat(underTest.getDebug()).as("The error code should match with the known error code in the test")
