...
public class MgmtContentTypeTest extends AbstractManagementApiIntegrationTest {
    ...
    private static final String JSON_PATH_FOR_NAME = "[0]name";
    private static final String JSON_PATH_MEDIA_TYPE = ";charset=UTF-8";

    @BeforeEach
    public void setupBeforeTest() {
        ds = testdataFactory.generateDistributionSet(DS_NAME);
    }
    ...
    public void postDistributionSet_ContentTypeJsonUtf8_woAccept() throws Exception {
        ...
        final MvcResult result = mvc.perform(post(MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, String.valueOf(tenantId)).content(JsonBuilder.distributionSets(Collections.singletonList(ds)))
                        .contentType(MediaType.APPLICATION_JSON_UTF8)).andDo(MockMvcResultPrinter.print())
                .andExpect(status().isCreated()).andExpect(jsonPath(JSON_PATH_FOR_NAME, equalTo(DS_NAME))).andReturn();

        assertEquals(MediaTypes.HAL_JSON_VALUE + JSON_PATH_MEDIA_TYPE, getResponseHeaderContentType(result));
    }
    ...
    public void postDistributionSet_ContentTypeJsonUtf8_wAcceptJson() throws Exception {
        ...
        final MvcResult result = mvc.perform(post(MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, String.valueOf(tenantId)).content(JsonBuilder.distributionSets(Collections.singletonList(ds)))
                ...
                .andExpect(jsonPath(JSON_PATH_FOR_NAME, equalTo(DS_NAME))).andReturn();
    ...
    public void postDistributionSet_ContentTypeJson_wAcceptJsonUtf8() throws Exception {
        final Long tenantId = 1L;
        final MvcResult result = mvc.perform(post(MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, String.valueOf(tenantId))
    ...
    public void getDistributionSet_woAccept() throws Exception {
        final Long tenantId = 1L;
        final MvcResult result = mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, String.valueOf(tenantId))).andDo(MockMvcResultPrinter.print())
    ...
    public void getDistributionSet_wAcceptJson() throws Exception {
        final Long tenantId = 1L;
        final MvcResult result = mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, String.valueOf(tenantId)).accept(MediaType.APPLICATION_JSON))
    ...
    public void getDistributionSet_wAcceptJsonUtf8() throws Exception {
        final Long tenantId = 1L;
        final MvcResult result = mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, String.valueOf(tenantId)).accept(MediaType.APPLICATION_JSON_UTF8))
                .andDo(MockMvcResultPrinter.print()).andExpect(status().isOk())
                .andReturn();
    ...
    public void getDistributionSet_wAcceptHalJson() throws Exception {
        final Long tenantId = 1L;
        final MvcResult result = mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, String.valueOf(tenantId)).accept(MediaTypes.HAL_JSON))
                .andDo(MockMvcResultPrinter.print()).andExpect(status().isOk())
                .andReturn();
