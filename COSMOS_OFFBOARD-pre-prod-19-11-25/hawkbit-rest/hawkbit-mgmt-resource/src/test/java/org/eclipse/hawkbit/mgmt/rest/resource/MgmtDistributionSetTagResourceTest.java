...
public class MgmtDistributionSetTagResourceTest extends AbstractManagementApiIntegrationTest {
    ...
    private static final String DISTRIBUTIONSETS_BASE_URL = "/distributionsets";
    ...
    public void getDistributionSetTags() throws Exception {
        ...
        mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_TAG_V1_REQUEST_MAPPING, TEST_TENANT_ID).accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(applySelfLinkMatcherOnPagedResult(assigned, DISTRIBUTIONSETTAGS_ROOT.replace(TENANT_ID, String.valueOf(TEST_TENANT_ID)) + assigned.getId()))
                .andExpect(applySelfLinkMatcherOnPagedResult(unassigned, DISTRIBUTIONSETTAGS_ROOT.replace(TENANT_ID, String.valueOf(TEST_TENANT_ID)) + unassigned.getId()))
    ...
    public void getDistributionSetTagsByDistributionSetId() throws Exception {
        ...
        mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_TAG_V1_REQUEST_MAPPING, TEST_TENANT_ID)
                ...
                .andExpect(applySelfLinkMatcherOnPagedResult(tag1, DISTRIBUTIONSETTAGS_ROOT.replace(TENANT_ID, String.valueOf(TEST_TENANT_ID)) + tag1.getId()))
                .andExpect(applySelfLinkMatcherOnPagedResult(tag2, DISTRIBUTIONSETTAGS_ROOT.replace(TENANT_ID, String.valueOf(TEST_TENANT_ID)) + tag2.getId()))
                .andExpect(jsonPath(MgmtTargetResourceTest.JSON_PATH_PAGED_LIST_TOTAL, equalTo(2)))
                .andExpect(jsonPath(MgmtTargetResourceTest.JSON_PATH_PAGED_LIST_SIZE, equalTo(2)))
                .andExpect(jsonPath(MgmtTargetResourceTest.JSON_PATH_PAGED_LIST_CONTENT, hasSize(2)));
    ...
    public void getDistributionSetTagsByDistributionSetIdAndTagDescription() throws Exception {
        ...
        mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_TAG_V1_REQUEST_MAPPING
                        ...
                        "=distributionset.id==" + distributionSet1.getId() + ";description==" + tag1.getDescription(), TEST_TENANT_ID)
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultPrinter.print()).andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(applyBaseEntityMatcherOnPagedResult(tag1))
    ...
    public void getDistributionSetTag() throws Exception {
        ...
        mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_TAG_ID_V1_REQUEST_MAPPING, TEST_TENANT_ID, assigned.getId() )
                        .accept(MediaType.APPLICATION_JSON)).andDo(MockMvcResultPrinter.print()).andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(applyTagMatcherOnSingleResult(assigned))
                .andExpect(applySelfLinkMatcherOnSingleResult(DISTRIBUTIONSETTAGS_ROOT.replace(TENANT_ID, String.valueOf(TEST_TENANT_ID)) + assigned.getId()))
                .andExpect(jsonPath("_links.assignedDistributionSets.href",
                        equalTo(DISTRIBUTIONSETTAGS_ROOT.replace(TENANT_ID, String.valueOf(TEST_TENANT_ID)) + assigned.getId() + "/distributionsets?offset=0&limit=50")));
    }
    ...
    public void createDistributionSetTags() throws JSONException, Exception {
        ...
        final ResultActions result = mvc
                .perform(post(MgmtRestConstants.DISTRIBUTIONSET_TAG_V1_REQUEST_MAPPING, TEST_TENANT_ID)
    ...
    public void updateDistributionSetTag() throws Exception {
        ...
        final ResultActions result = mvc
                .perform(put(MgmtRestConstants.DISTRIBUTIONSET_TAG_V1_REQUEST_MAPPING + "/" + original.getId(), TEST_TENANT_ID)
    ...
    public void deleteDistributionSetTag() throws Exception {
        ...
        mvc.perform(delete(MgmtRestConstants.DISTRIBUTIONSET_TAG_ID_V1_REQUEST_MAPPING, TEST_TENANT_ID, original.getId()))
                .andDo(MockMvcResultPrinter.print()).andExpect(status().isOk());
    ...
    public void getAssignedDistributionSets() throws Exception {
        ...
        mvc.perform(get(MgmtRestConstants.DISTRIBUTIONSET_TAG_ASSOCIATION_DS_V1_REQUEST_MAPPING, TEST_TENANT_ID, tag.getId()))
    ...
    private ResultActions toggle(final DistributionSetTag tag, final List<DistributionSet> sets) throws Exception {
        return mvc
                .perform(patch(MgmtRestConstants.DISTRIBUTIONSET_TAG_ASSOCIATION_DS_V1_REQUEST_MAPPING, TEST_TENANT_ID, tag.getId(), TEST_TENANT_ID).content(
    ...
    public void assignDistributionSets() throws Exception {
        ...
        final ResultActions result = mvc
                .perform(
                        post(MgmtRestConstants.DISTRIBUTIONSET_TAG_ASSOCIATION_DS_V1_REQUEST_MAPPING, TEST_TENANT_ID, tag.getId())
    ...
    public void unassignDistributionSet() throws Exception {
        ...
        mvc.perform(delete(MgmtRestConstants.DISTRIBUTIONSET_TAG_UNASSOCIATION_ID_V1_REQUEST_MAPPING, TEST_TENANT_ID, tag.getId(),unassigned.getId())).andDo(MockMvcResultPrinter.print()).andExpect(status().isOk());
