...
public interface MgmtDistributionSetRestApi {
    ...
    ResponseEntity<PagedList<MgmtDistributionSet>> getDistributionSets(@PathVariable("tenantId") long tenantId,
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ONE_V1_REQUEST_MAPPING, produces = {
            MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtDistributionSet> getDistributionSet(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId);
    ...
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSET_V1_REQUEST_MAPPING, consumes = {MediaTypes.HAL_JSON_VALUE,
            ...
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<List<MgmtDistributionSet>> createDistributionSets(@PathVariable("tenantId") long tenantId, List<MgmtDistributionSetRequestBodyPost> sets);
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ONE_V1_REQUEST_MAPPING)
    ResponseEntity<Void> deleteDistributionSet(@PathVariable("tenantId") Long tenantId, @PathVariable("distributionSetId") Long distributionSetId);
    ...
    @PutMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ONE_V1_REQUEST_MAPPING, consumes = {
    ...
    ResponseEntity<MgmtDistributionSet> updateDistributionSet(@PathVariable("tenantId") Long tenantId,
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ASSIGNED_TARGETS_V1_REQUEST_MAPPING_TENANT, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<PagedList<MgmtTarget>> getAssignedTargets(@PathVariable("distributionSetId") Long distributionSetId, @PathVariable("tenantId") Long tenantId,
                                                             @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_OFFSET, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_OFFSET) int pagingOffsetParam,
                                                             @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_LIMIT, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_LIMIT) int pagingLimitParam,
                                                             @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SORTING, required = false) String sortParam,
                                                             @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SEARCH, required = false) String rsqlParam);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_INSTALLED_TARGETS_V1_REQUEST_MAPPING_TENANT, produces = {MediaTypes.HAL_JSON_VALUE,

            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<PagedList<MgmtTarget>> getInstalledTargets(@PathVariable("distributionSetId") Long distributionSetId, @PathVariable("tenantId") Long tenantId,
                                                              @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_OFFSET, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_OFFSET) int pagingOffsetParam,
                                                              @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_LIMIT, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_LIMIT) int pagingLimitParam,
                                                              @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SORTING, required = false) String sortParam,
                                                              @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SEARCH, required = false) String rsqlParam);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_AUTO_ASSIGN_TARGET_FILTER_V1_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE,
     ...
     * distribution set.
     * @deprecated This POST API is deprecated.
     ...
     */
    @Operation(summary = "Assigning multiple targets to a single distribution set", description = "This Api is deprecated")
    @ApiResponses(value = {
    ...
    @Deprecated
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSET_CREATE_ASSIGNED_TARGET_V1_REQUEST_MAPPING_TENANT, consumes = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE}, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_METADATA_V1_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<PagedList<MgmtMetadata>> getMetadata(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId,
                                                        @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_OFFSET, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_OFFSET) int pagingOffsetParam,
                                                        @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_LIMIT, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_LIMIT) int pagingLimitParam,
                                                        @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SORTING, required = false) String sortParam,
                                                        @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SEARCH, required = false) String rsqlParam);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_DELETE_METADATA_V1_REQUEST_MAPPING, produces = {MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtMetadata> getMetadataValue(@PathVariable("tenantId") long tenantId,
                                                  @PathVariable("distributionSetId") Long distributionSetId,
                                                  @PathVariable("key") String metadataKey);
    ...
    @PutMapping(value = MgmtRestConstants.DISTRIBUTIONSET_DELETE_METADATA_V1_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtMetadata> updateMetadata(@PathVariable("tenantId") long tenantId,
                                                @PathVariable("distributionSetId") Long distributionSetId,
                                                @PathVariable("key") String metadataKey, MgmtMetadataBodyPut metadata);
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSET_DELETE_METADATA_V1_REQUEST_MAPPING)

    ResponseEntity<Void> deleteMetadata(@PathVariable("tenantId") long tenantId,
                                        @PathVariable("distributionSetId") Long distributionSetId,
                                        @PathVariable("key") String metadataKey);
    ...
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSET_CREATE_METADATA_V1_REQUEST_MAPPING, consumes = {MediaType.APPLICATION_JSON_VALUE,

            MediaTypes.HAL_JSON_VALUE}, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<List<MgmtMetadata>> createMetadata(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId,
     ...
     * @param softwareModuleAssignments the list of software modules ids to assign
     * @return http status
     */
    ...
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ASSIGNED_SOFTWAREMODULES_V1_REQUEST_MAPPING, consumes = {MediaType.APPLICATION_JSON_VALUE,

            MediaTypes.HAL_JSON_VALUE}, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<Void> assignSoftwareModules(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId,
                                               @RequestBody @Valid List<MgmtSoftwareModuleAssignments> softwareModuleAssignments
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSET_DELETE_SOFTWAREMODULES_V1_REQUEST_MAPPING)

    ResponseEntity<Void> deleteAssignSoftwareModules(@PathVariable("tenantId") long tenantId,
                                                     @PathVariable("distributionSetId") Long distributionSetId,
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ASSIGNED_SOFTWAREMODULES_V1_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE,

            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<PagedList<MgmtAssignedSoftwareModule>> getAssignedSoftwareModules(
            @PathVariable("tenantId") long tenantId,
            @PathVariable("distributionSetId") Long distributionSetId,
            @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_OFFSET, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_OFFSET) int pagingOffsetParam,
            @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_LIMIT, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_LIMIT) int pagingLimitParam,
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ROLLOUTS_V1_REQUEST_MAPPING, produces = {
            MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtDistributionSetStatistics> getRolloutsCountByStatusForDistributionSet(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ACTIONS_V1_REQUEST_MAPPING, produces = {
            MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtDistributionSetStatistics> getActionsCountByStatusForDistributionSet(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_AUTO_ASSIGNMENTS_V1_REQUEST_MAPPING, produces = {
            MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtDistributionSetStatistics> getAutoAssignmentsCountForDistributionSet(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_STATISTICS_V1_REQUEST_MAPPING, produces = {
            MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtDistributionSetStatistics> getStatisticsForDistributionSet(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId);
    ...
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSET_ONE_V1_REQUEST_MAPPING, consumes = {MediaTypes.HAL_JSON_VALUE,

            MediaType.APPLICATION_JSON_VALUE}, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<Void> invalidateDistributionSet(@PathVariable("tenantId") long tenantId, @PathVariable("distributionSetId") Long distributionSetId,
