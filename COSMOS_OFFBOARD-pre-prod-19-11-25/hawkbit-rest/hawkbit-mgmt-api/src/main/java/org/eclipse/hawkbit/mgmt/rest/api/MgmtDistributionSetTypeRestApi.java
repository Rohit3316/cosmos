...
public interface MgmtDistributionSetTypeRestApi {
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_ONE_V1_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_ONE_V1_REQUEST_MAPPING)
    ResponseEntity<Void> deleteDistributionSetType(@PathVariable("tenantId") long tenantId, @PathVariable("typeId") Long typeId);
    ...
    @PutMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_ONE_V1_REQUEST_MAPPING, consumes = {MediaTypes.HAL_JSON_VALUE,
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_MND_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE,
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_MND_ID_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})

    ResponseEntity<MgmtSoftwareModuleType> getMandatoryModule(
            @PathVariable("tenantId") long tenantId,
            @PathVariable("typeId") Long typeId,
            @PathVariable("moduleTypeId") Long moduleTypeId);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_OPT_ID_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_OPT_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE,
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_MND_ID_REQUEST_MAPPING)

    ResponseEntity<Void> removeMandatoryModule(@PathVariable("tenantId") long tenantId, @PathVariable("typeId") Long typeId,
                                               @PathVariable("moduleTypeId") Long moduleTypeId);
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_OPT_ID_REQUEST_MAPPING)

    ResponseEntity<Void> removeOptionalModule(@PathVariable("tenantId") long tenantId, @PathVariable("typeId") Long typeId,
                                              @PathVariable("moduleTypeId") Long moduleTypeId);
    ...
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_MND_REQUEST_MAPPING, consumes = {MediaTypes.HAL_JSON_VALUE,

            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<Void> addMandatoryModule(@PathVariable("tenantId") long tenantId, @PathVariable("typeId") Long typeId,
                                            MgmtId smtId);
    ...
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSETTYPE_V1_OPT_REQUEST_MAPPING, consumes = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<Void> addOptionalModule(@PathVariable("tenantId") long tenantId, @PathVariable("typeId") Long typeId,
                                           MgmtId smtId);
