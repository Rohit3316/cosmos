...
public interface MgmtDistributionSetTagRestApi {
     ...
     *
     * @param tagId the ID of the distribution set tag to retrieve
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_TAG_ID_V1_REQUEST_MAPPING, produces = {MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})

    ResponseEntity<MgmtTag> getDistributionSetTag(@PathVariable("tenantId") Long tenantId, @PathVariable("tagId") Long tagId);
    ...
    ResponseEntity<List<MgmtTag>> createDistributionSetTags(@PathVariable("tenantId") Long tenantId, List<MgmtTagRequestBodyPut> tags);

    /**
     * Handles the PUT request of updating a single distribution set tag.
     *
     * @param tagId         the ID of the distribution set tag
    ...
    @PutMapping(value = MgmtRestConstants.DISTRIBUTIONSET_TAG_ID_V1_REQUEST_MAPPING, consumes = {MediaTypes.HAL_JSON_VALUE,

            MediaType.APPLICATION_JSON_VALUE}, produces = {MediaTypes.HAL_JSON_VALUE,
            MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<MgmtTag> updateDistributionSetTag(@PathVariable("tenantId") Long tenantId, @PathVariable("tagId") Long tagId,
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSET_TAG_ID_V1_REQUEST_MAPPING)
    ResponseEntity<Void> deleteDistributionSetTag(@PathVariable("tenantId") Long tenantId, @PathVariable("tagId") Long tagId);
    ...
    @GetMapping(value = MgmtRestConstants.DISTRIBUTIONSET_TAG_ASSOCIATION_DS_V1_REQUEST_MAPPING, produces = {
            MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE})
    ResponseEntity<PagedList<MgmtDistributionSet>> getAssignedDistributionSets(
            @PathVariable("tenantId") Long tenantId, @PathVariable("tagId") Long tagId,
            @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_OFFSET, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_OFFSET) int pagingOffsetParam,
            @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_PAGING_LIMIT, defaultValue = MgmtRestConstants.REQUEST_PARAMETER_PAGING_DEFAULT_LIMIT) int pagingLimitParam,
            @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SORTING, required = false) String sortParam,
            @RequestParam(value = MgmtRestConstants.REQUEST_PARAMETER_SEARCH, required = false) String rsqlParam);
    ...
    /**
     * Handles the PATCH request to toggle the assignment of distribution sets by
     * the given tag id.
     *
     * @param tagId                   the ID of the distribution set tag to retrieve
    ...
    @PatchMapping(value = MgmtRestConstants.DISTRIBUTIONSET_TAG_ASSOCIATION_DS_V1_REQUEST_MAPPING)
    ...
    @PostMapping(value = MgmtRestConstants.DISTRIBUTIONSET_TAG_ASSOCIATION_DS_V1_REQUEST_MAPPING, consumes = {
    ...
    @DeleteMapping(value = MgmtRestConstants.DISTRIBUTIONSET_TAG_UNASSOCIATION_ID_V1_REQUEST_MAPPING)
    ResponseEntity<Void> unassignDistributionSet(@PathVariable("tenantId") Long tenantId, @PathVariable("tagId") Long tagId,
